...
export const SCHOOL_NAME = "Downtown Doral Charter Upper School";
export const SCHOOL_SHORT_NAME = "Doral Academy";

// Fill these in once you have them -- shown at the bottom of the About page.
export const CONTACT_INSTAGRAM = "@marqueeddcus";
export const CONTACT_EMAIL = "contact.heymarquee@gmail.com";
